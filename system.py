...
class System:
    ...
    def help(self):
        ...
        print('listen [object] - allows you to smell an object or room; this may give you more clues\033[0;37;40m')
        return
    ...
    def load(self):
        ...
        print('\033[1;33;40mEnter the location of the save file to load the game from (case sensitive): \033[0;37;40m')
        location = input('\033[0;32;40m')
        print('\033[0;37;40m')
